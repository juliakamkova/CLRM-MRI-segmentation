...
if __name__ == '__main__':
    ...
    if args.restore:
        ...
        early_stop = EarlyStopping(monitor='val_epoch_Loss', patience=20, mode='min')
        ...
        checkpoint_callback = ModelCheckpoint(**params['checkpoint'], dirpath=str(configdir / 'checkpoints'), filename='{epoch}-{val_epoch_Loss:.3f}')
        trainer = pl.Trainer(**params['lightning'], logger=logger, callbacks=[checkpoint_callback, early_stop, lr_monitor])
    else:
